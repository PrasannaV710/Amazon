	...
	Date date = new Date();
        ...
        */
          ...
          //  out.println("<h1>Servlet request at " + request.getContextPath() + "</h1>");
            out.println("<meta http-equiv=\"refresh\" content=\"0; URL='http://localhost:8081/LabEval4/home.jsp'\" />");
            out.println("</body>");
            out.println("</html>");
        }
         creds = new BasicAWSCredentials("AKIAJO3AQ4PKIQOMWW6Q", "QPsARJ9jylCw31jreUzaZ0GE5GdAhZhwEM5Oanis");
